...
**Model:** [`Mcrowe1210/gemma-4-mycelium-e4b`](https://ollama.com/Mcrowe1210/gemma-4-mycelium-e4b) on Ollama Hub (Phase 2 LoRA will publish to HuggingFace when training completes — see Phase 2 notes below)
